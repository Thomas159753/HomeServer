                    ...
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8 border-2 rounded-md border-black">
                        ...
                        <form className="space-y-4 md:space-y-6">
                            ...
                            <div>
                                ...
                                <input className="block w-full border border-black rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-black focus:border-black transition" type="password" name="password" id="password" placeholder="•••••••" required/>
                            </div>
                            <div className="flex items-center justify-between">
                                <div className="flex items-start">
                                    <div className="flex items-center h-5">
                                        <input id="remember" aria-describedby="remember" type="checkbox" className="w-4 h-4 border focus:ring-2" required/>
                                    </div>
                            ...
                            <button className="w-full border border-black rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-black focus:border-black transition" type="submit" >Sign in</button>
                            <p>
                                Don’t have an account yet? <a className="font-medium hover:underline ml-1" href="#">Sign up</a>
                            </p>
